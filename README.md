...
CaLMPhosKAN ├── dataset │ ├── Readme.md # Description of the dataset │ ├── test_Serine+Threonine.csv # Test dataset for Serine and Threonine residues │ ├── test_Tyrosine.csv # Test dataset for Tyrosine residues │ ├── train_Serine+Threonine.csv # Training dataset for Serine and Threonine residues │ └── train_Tyrosine.csv # Training dataset for Tyrosine residues ├── evaluate.py # Script to evaluate the models ├── images │ ├── Calmphoskan_architecture.png # Diagram of the CaLMPhosKAN architecture │ ├── example_output_ST.png # Example output for Serine and Threonine │ ├── example_output_Y.png # Example output for Tyrosine │ ├── example_run.png # Example run of the model │ ├── mdhhs.png # Image related to the study │ ├── NSF_Official_logo.svg # Official logo of NSF │ └── Protein_translation.png # Diagram for protein translation ├── KAN.py # Main script for the KAN model ├── LICENSE # License information for the repository ├── models │ ├── ST_model.pth # Model weights for Serine and Threonine │ └── Y_model.pth # Model weights for Tyrosine ├── README.md # Documentation for the repository └── requirements.txt # List of required Python packages
